...
- **Global scope**: `/Users/ruihao/Documents/github/agent-talkie/.cursor/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/ruihao/Documents/github/agent-talkie/.cursor/notes/`)
...
2. Glob `/Users/ruihao/Documents/github/agent-talkie/.cursor/notes/*.md` (if directory exists) — global notes
...
Global (/Users/ruihao/Documents/github/agent-talkie/.cursor/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/ruihao/Documents/github/agent-talkie/.cursor/notes/` — works in any directory
