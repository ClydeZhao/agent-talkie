...
- Usage: Reference from command with `@/Users/ruihao/Documents/github/agent-talkie/.cursor/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/ruihao/Documents/github/agent-talkie/.cursor/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/ruihao/Documents/github/agent-talkie/.cursor/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
