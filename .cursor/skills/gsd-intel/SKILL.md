...
Intel system is disabled. To activate:
  ...
  node /Users/ruihao/Documents/github/agent-talkie/.cursor/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node /Users/ruihao/Documents/github/agent-talkie/.cursor/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node /Users/ruihao/Documents/github/agent-talkie/.cursor/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node /Users/ruihao/Documents/github/agent-talkie/.cursor/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: /Users/ruihao/Documents/github/agent-talkie/.cursor/get-shit-done/bin/gsd-tools.cjs
