...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/ruihao/Documents/github/agent-talkie/.cursor
                  → checks /Users/ruihao/Documents/github/agent-talkie/.cursor/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/ruihao/Documents/github/agent-talkie/.cursor/get-shit-done
                  → writes to /Users/ruihao/Documents/github/agent-talkie/.cursor/get-shit-done/hooks/
...
@/Users/ruihao/Documents/github/agent-talkie/.cursor/get-shit-done/references/thinking-models-debug.md
...
- Read @/Users/ruihao/Documents/github/agent-talkie/.cursor/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/Users/ruihao/Documents/github/agent-talkie/.cursor/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/ruihao/Documents/github/agent-talkie/.cursor/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/ruihao/Documents/github/agent-talkie/.cursor/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
