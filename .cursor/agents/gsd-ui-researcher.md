...
Use template from `/Users/ruihao/Documents/github/agent-talkie/.cursor/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/ruihao/Documents/github/agent-talkie/.cursor/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/ruihao/Documents/github/agent-talkie/.cursor/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
